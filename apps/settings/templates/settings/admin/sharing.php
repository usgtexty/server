...
<?php } ?>
	...
	print_unescaped('checked="checked"');
			...
			<label for="shareapi_allow_share_dialog_user_enumeration"><?php p($l->t('Allow account name autocompletion in share dialog and allow access to the system address book'));?></label><br />
		</p>
	...
	print_unescaped('checked="checked"');
			...
			<label for="shareapi_restrict_user_enumeration_to_group"><?php p($l->t('Allow account name autocompletion to users within the same groups and limit system address books to users in the same groups'));?></label><br />
		</p>
